...
with DAG(dag_id="7.2-externalTaskSensor",
    ...
    t1 = ExternalTaskSensor(task_id="waiting_dag",
							external_dag_id="7.1-externalTaskSensor", # si solo se usa dag_id espera que se complete el dag
							external_task_id="tarea_1", # esto es cuando se espera una tarea especifica del dag
